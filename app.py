...
df_fitur1 = pd.read_csv('dataset/user_rating_clean.csv')
model_fitur1 = tf.keras.models.load_model('model-ml/fitur1-2.h5')
destinations_fitur2 = pd.read_pickle('model-ml/fitur2.pkl')
item_similarity_model_fitur3 = pd.read_pickle('model-ml/fitur3.pkl')
